...
<section
	class="top-0 z-50 flex border-b-2 border-white bg-white md:sticky dark:bg-gray-950 print:hidden"
>
	...
	<button
		class="my-auto ml-auto flex flex-row-reverse gap-2 rounded-none lg:flex-row"
		onclick={() => toggleTheme()}
		type="button"
	>
...
<div class="flex flex-col items-center justify-center">
	{#if isOnResume}
		<div
			class="fixed top-[unset] right-[unset] bottom-0 left-0 mx-auto ml-auto btn-group w-full flex-wrap items-end justify-around rounded-bl-md bg-white lg:top-16 lg:right-0 lg:bottom-[unset] lg:left-[unset] lg:mx-0 lg:w-fit lg:flex-col lg:bg-white/75 dark:bg-black lg:dark:bg-white/25 print:hidden"
		>
			<a
	...
	{/if}
	<div
		class="outline-primary-300-900 m-2 bg-white/75 p-4 outline outline-1 -outline-offset-4 lg:my-8 lg:p-8 dark:bg-black/75 print:!mx-8 print:outline-transparent"
	>
...
<section id="github-corner-section" class="hidden md:block print:hidden">
	...
	<a id="github-corner" target="_blank" href="https://github.com/mattkbrat/portfolio">
		<div
			class="fixed bottom-0 left-0 -mb-[100px] -ml-[150px] h-[200px] w-[200px] rotate-45 cursor-pointer border-t-2 border-surface-200-800 bg-black/5 bg-surface-50-950 text-[0px]"
		>
			Github
		</div>
	</a>
